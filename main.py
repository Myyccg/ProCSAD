...
if __name__ == '__main__':
    ...
    parser.add_argument('--framework', nargs="+", type=str, default=['ProCSAD'])
    ...
    # Ablation study: model version selection



    parser.add_argument('--model_version', type=str, default='full',

                        help='Model version tag for checkpoint naming, e.g., full, wo_svdd, wo_memory, wo_cl, wo_svr')



    parser.add_argument('--use_our_embedding', type=str, default='True', choices=['True', 'False'],



                        help='Use BiMamba temporal encoder for encoder_branch1')



    parser.add_argument('--use_wavelet_branch2', type=str, default='False', choices=['True', 'False'],



                        help='Use wavelet encoder for encoder_branch2')



    parser.add_argument('--pure_mamba', type=str, default='True', choices=['True', 'False'],



                        help='Use pure BiMamba without FFT in t-Encoder')
    ...
    parser.add_argument('--axial_layers', type=int, default=1, help='Number of Axial Attention layers in i-Encoder')



    parser.add_argument('--attn_type', type=str, default='scale', choices=['scale', 'axial'],



                        help='Attention type for Wavelet i-Encoder: scale (Scale-Trans) or axial (Axial-Attn)')



    parser.add_argument('--use_contrastive', type=str, default='True', choices=['True', 'False'],



                        help='Use contrastive learning with segment/channel masking')



    parser.add_argument('--proj_dim', type=int, default=32, help='Projection dimension for contrastive learning')



    parser.add_argument('--lambda_cl_time', type=float, default=0.1, help='Weight for temporal contrastive loss')



    parser.add_argument('--lambda_cl_freq', type=float, default=0.1, help='Weight for frequency contrastive loss')



    parser.add_argument('--mask_ratio', type=float, default=0.15, help='Mask ratio for contrastive augmentation')



    parser.add_argument('--auto_cl_dataset', type=str, default='True', choices=['True', 'False'],



                        help='Use dataset-adaptive defaults for contrastive loss weights')



    parser.add_argument('--cl_warmup_epochs', type=int, default=3,



                        help='Warmup epochs before validation-driven contrastive gating starts')



    parser.add_argument('--cl_patience', type=int, default=2,



                        help='Patience for validation contrastive loss before disabling contrastive terms')



    parser.add_argument('--cl_min_delta', type=float, default=1e-4,



                        help='Minimum validation contrastive loss improvement to keep contrastive terms enabled')



    parser.add_argument('--cl_reenable', type=str, default='True', choices=['True', 'False'],



                        help='Allow contrastive terms to be re-enabled when validation contrastive loss improves again')
    ...
    parser.add_argument('--use_epsilon_tube', type=str, default='True', choices=['True', 'False'],



                        help='Use SVR-inspired ε-tube loss instead of MSE')



    parser.add_argument('--epsilon_init', type=float, default=0.1, help='Initial epsilon for ε-tube loss')



    parser.add_argument('--adaptive_epsilon_mode', type=str, default='none', 



                        choices=['none', 'feature_based', 'error_based'],



                        help='Adaptive epsilon mode: none=fixed, feature_based=adapt to error magnitude, error_based=adapt to error distribution')



    parser.add_argument('--lambda_consist', type=float, default=0.2,



                        help='Consistency regularization weight for ProtoSVDD loss')
    ...
    parser.add_argument('--use_dual_recon', type=str, default='False', choices=['True', 'False'],



                        help='Enable dual branch symmetric reconstruction (both t-Encoder and i-Encoder participate in reconstruction)')
    ...
    parser.add_argument('--use_memory', type=str, default='True', choices=['True', 'False'],



                        help='Use sinusoid prototype memory for attention-based anomaly scoring')
    ...
    parser.add_argument('--use_svdd', type=str, default='True', choices=['True', 'False'],



                        help='Use CD-SVDD for cross-domain compactness and consistency (replaces memory module)')
    ...
    parser.add_argument('--lambda_svdd', type=float, default=0.1,
                        ...
                        help='Weight for SVDD loss')



    parser.add_argument('--svdd_proj_dim', type=int, default=64,



                        help='SVDD projection dimension')
